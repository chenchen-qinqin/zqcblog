...
heroText: zqingchen blog
tagline: 个人知识库&博客，积跬步以至千里，致敬每个爱学习的你。
# actionText: 立刻进入 →
# actionLink: /web/
...
features: # 可选的
  - title: 前端
    details: HTML、JS、CSS和Vue框架等前端技术
    link: /web/ # 可选
...
- **WeChat or QQ**: <a href="tencent://message/?uin=480118282&Site=&Menu=yesUrl" class='qq'>480118282</a>
- **Email**: <a href="mailto:zqingchenit@163.com">zqingchenit@163.com</a>
- **GitHub**: <https://github.com/chenchen-qinqin>
